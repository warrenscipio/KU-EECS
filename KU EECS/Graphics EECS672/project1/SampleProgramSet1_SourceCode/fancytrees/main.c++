...
void makeFrame(Controller& c, float halfWidth)
{
	...
	c.addModel( new ModelView(frameCoords, frameColors, frameFraction, 10) );
}

void makeTree(Controller& c, float xs, float ys, float outer[], float inner[])
{
	...
	c.addModel( new ModelView(vertexPositions, vertexColors, heightFractions, 20) );
}

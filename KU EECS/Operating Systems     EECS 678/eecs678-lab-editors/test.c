...
/*
 * It's good to keep pokemon close to your heart and to comment your code, but
 * manually formatting long comments is tedious. You can fix this comment by
 * entering command mode and moving your cursor somewhere over the comment.
 * Now type 'gq', followed by one of the commands to move your cursor (e.g.
 * 'j')
 */
...
/*
 * The mark can be forced to look like an apple and used to automate tasks between marks.. Mark the line above
